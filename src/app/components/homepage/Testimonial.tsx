        ...
        <div className="grid md:grid-cols-3 gap-4">
          {testimonials.map((t, index) => (
            <motion.div
              ...
              className="relative overflow-hidden rounded-xl border border-border bg-card/60 p-7 flex flex-col gap-6 hover:border-primary/20 transition-colors duration-300 group"
            >
